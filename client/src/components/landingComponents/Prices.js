...
export default ({
  ...
  const defaultCards = [
    ...
    },
    {
      ...
      description:
        "Ruderinteressierte können an den Rudertagen und in Anfängerkursen (Mai und Juni)",
    },
    {
      imageSrc: uniHat,
      title: "Winter Übungen",
      description:
        "Im Winter trainieren wir in der Halle – Gymnastik, Ballspiele, Konditionstraining.",
    },
    {
      imageSrc: schoolBag,
      title: "Sportliche Erfolge",
      description:
        "Gold, Silber, Bronze bei den österreichischen Meisterschaften. ",
    },
    {
      imageSrc: signUp,
      title: "Lorem ipsum",
