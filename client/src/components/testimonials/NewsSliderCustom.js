...
import NewsBoard from "../blogs/NewsBoard.js";
...
class NewsSliderCustom extends Component {
  ...
  render() {
    ...
    const slicedNews = newsList.news.map((el, i, arr) => {
...
export default NewsSliderCustom;
